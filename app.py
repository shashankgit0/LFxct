...
" Batting": [
# Single blank
{"key":"bat_duck", "display":"{0} to score a duck (0 runs)", "fields":[{"
{"key":"bat_top", "display":"{0} to be the highest scorer in the team","fields":[{
{"key":"bat_sr200", "display":"{0} to have 200+ strike rate", "fields":[{
{"key":"bat_b1", "display":"{0} to hit a boundary on ball 1", "fields":[{
{"key":"bat_six1", "display":"{0} to hit a six on ball 1", "fields":[{
{"key":"bat_5six", "display":"{0} to hit 5+ sixes", "fields":[{
{"key":"bat_8four", "display":"{0} to hit 8+ fours", "fields":[{
{"key":"bat_50fast", "display":"{0} to score a fifty in less than 20 balls","fields":
{"key":"bat_pp30", "display":"{0} to score 30+ in the powerplay", "fields":[{
{"key":"bat_pp40", "display":"{0} to score 40+ in the powerplay", "fields":[{
{"key":"bat_nosix", "display":"{0} to not hit a single six", {"key":"bat_last", "display":"{0} to be the last wicket to fall", {"key":"bat_consix", "display":"{0} to hit consecutive sixes", {"key":"bat_gduck", "display":"{0} to be dismissed for a golden duck", # Multi blank
"fields":[{
"fields":[{
"fields":[{
"fields":[{
{"key":"bat_range", "display":"{0} to score between {1} and {2} runs", {"key":"bat_getout", "display":"{0} to get out for {1} runs", {"key":"bat_ofballs","display":"{0} to score {1}+ runs off {2} balls", {"key":"bat_nsix", "display":"{0} to hit {1} sixes in their innings", "fields":[{
"fields":[{
"fields":[{
"fields":[{
{"key":"bat_50over", "display":"{0} to score a fifty in less than {1} balls","fields"
],
" Bowling": [
# Single blank
{"key":"bowl_1w", "display":"{0} to take 1 wicket", "fields":[{
{"key":"bowl_2w", "display":"{0} to take 2 wickets", "fields":[{
{"key":"bowl_3w", "display":"{0} to take 3 wickets", "fields":[{
{"key":"bowl_3wp", "display":"{0} to take 3+ wickets", "fields":[{
{"key":"bowl_mdn", "display":"{0} to bowl a maiden over", "fields":[{
{"key":"bowl_top", "display":"{0} to be the top wicket taker", "fields":[{
{"key":"bowl_eco6", "display":"{0} to have economy under 6", "fields":[{
{"key":"bowl_eco7", "display":"{0} to have economy under 7", "fields":[{
{"key":"bowl_dot10", "display":"{0} to bowl 10+ dot balls", "fields":[{
{"key":"bowl_wide", "display":"{0} to bowl 3+ wides", "fields":[{
{"key":"bowl_nb", "display":"{0} to bowl 2+ no balls", "fields":[{
{"key":"bowl_fb", "display":"{0} to take a wicket on their first ball", "fields":[
{"key":"bowl_pp", "display":"{0} to take a wicket in the powerplay", "fields":[{
{"key":"bowl_bb", "display":"{0} to take back to back wickets", "fields":[{
{"key":"bowl_zero", "display":"{0} to concede 0 runs in an over", "fields":[{
{"key":"bowl_hat", "display":"{0} to take a hat trick", "fields":[{
{"key":"bowl_exp", "display":"{0} to be the most expensive bowler", "fields":[{
{"key":"bowl_top2", "display":"{0} to dismiss the top scorer", "fields":[{
# Multi blank
{"key":"bowl_wktruns","display":"{0} to take {1} wicket/s for under {2} runs","fields
{"key":"bowl_conc", "display":"{0} to concede under {1} runs in {2} overs","fields":
{"key":"bowl_dotn", "display":"{0} to bowl {1} dot balls in their spell","fields":[{
{"key":"bowl_overn", "display":"{0} to take a wicket in over {1}", "fields":[{
{"key":"bowl_4ovr", "display":"{0} to bowl 4 overs for under {1} runs", "fields":[{
],
" Team": [
# Single blank
{"key":"team_200p", "display":"{0} team to score 200+ runs", {"key":"team_u130", "display":"{0} team to score under 130 runs", {"key":"team_6s11", "display":"{0} team to hit 11+ sixes", {"key":"team_6s15", "display":"{0} team to hit 15+ sixes", {"key":"team_4s19", "display":"{0} team to hit 19+ fours", {"key":"team_win10", "display":"{0} team to win by 10+ wickets", {"key":"team_win50", "display":"{0} team to win by 50+ runs", "fields":[{
"fields":[{
"fields":[{
"fields":[{
"fields":[{
"fields":[{
"fields":[{
{"key":"team_allout","display":"{0} team to be all out", "fields":[{
{"key":"team_fw3", "display":"{0} team to lose first wicket inside 3 overs","fields
{"key":"team_fw6", "display":"{0} team to lose first wicket after 6 overs","fields"
{"key":"team_100p", "display":"{0} team to have a 100+ partnership", "fields":[{
{"key":"team_six1", "display":"{0} team to hit a six on the first ball", "fields":[{
{"key":"team_ext10", "display":"{0} team to have 10+ extras total", "fields":[{
{"key":"team_pp50", "display":"{0} team to score 50+ in powerplay", "fields":[{
{"key":"team_pp60", "display":"{0} team to score 60+ in powerplay", "fields":[{
{"key":"team_d20", "display":"{0} team to score 20+ in the last 2 overs","fields":[
{"key":"team_d30", "display":"{0} team to score 30+ in the last 2 overs","fields":[
# Multi blank
{"key":"team_range", "display":"{0} team to score between {1} and {2} runs","fields":
{"key":"team_over", "display":"{0} team to score {1} runs in over {2}", "fields":[{
{"key":"team_pprange","display":"{0} team to score between {1} and {2} in powerplay",
{"key":"team_lastn", "display":"{0} team to score {1}+ in the last {2} overs","fields
{"key":"team_wktn", "display":"{0} team to lose their first wicket in over {1}","fie
{"key":"team_partnr","display":"{0} team to have a {1}+ partnership", "fields":[{
],
" Special": [
{"key":"sp_mom", "display":"{0} to win Man of the Match", "fields":[{
{"key":"sp_catch2", "display":"{0} to take 2+ catches", "fields":[{
{"key":"sp_runout", "display":"{0} to be involved in a run out", "fields":[{
{"key":"sp_last", "display":"{0} team to win off the last ball", "fields":[{
{"key":"sp_super", "display":"Match to go to a Super Over", "fields":[{
{"key":"sp_toss_bat","display":"{0} to win toss and choose to bat", "fields":[{
{"key":"sp_toss_bowl","display":"{0} to win toss and choose to bowl", "fields":[{
{"key":"sp_allround","display":"{0} to score 30+ and take 2+ wickets", "fields":[{"
{"key":"sp_top3_20", "display":"Top 3 batters of {0} to all score 20+", "fields":[{"
{"key":"sp_six1st", "display":"First ball of the match to be a six", "fields":[{"
{"key":"sp_wkt1st", "display":"First ball of the match to be a wicket", "fields":[{"
{"key":"sp_30sixes", "display":"Match to have 30+ sixes total", "fields":[{
{"key":"sp_open20", "display":"Both openers of {0} to score 20+", "fields":[{"
{"key":"sp_open30", "display":"Both openers of {0} to score 30+", "fields":[{"
{"key":"sp_d6six", "display":"Last 5 overs to have {0}+ sixes", "fields":[{"
],
}
# ─── Helpers ───────────────────────────────────────────────────────────────────
def get_all_users():
...
def sp_pts(username):
total = 0
for p in db().table("predictions").select("points_awarded").eq("player", username).execut
try: total += float(p.get("points_awarded") or 0)
except: pass
return round(total, 2)
def bp_pts(username):
total = 0
for b in db().table("pool_bps").select("points_awarded").eq("player", username).execute()
try: total += float(b.get("points_awarded") or 0)
except: pass
return round(total, 2)
def streak_pts(username):
total = 0
for s in db().table("streaks").select("bonus_points").eq("player", username).execute().da
try: total += float(s.get("bonus_points") or 0)
except: pass
return round(total, 2)
def season_pts(username):
total = 0
for s in db().table("season_predictions").select("points_awarded").eq("player", username)
try: total += float(s.get("points_awarded") or 0)
except: pass
return round(total, 2)
def total_pts(username):
return round(sp_pts(username) + bp_pts(username) + streak_pts(username) + season_pts(user
...
streak = 0
for p in done:
all_p = db().table("predictions").select("*").eq("match_name", p["match_name"]).execu
valid = [x for x in all_p if x.get("actual_score") is not None]
if not valid: break
min_diff = min(abs(int(x.get("predicted_score") or 0) - int(x.get("actual_score") or
...
res = db().table("users").select("*").eq("username", username).eq("password", password).e
return res.data[0] if res.data else None
def calc_sp_wins(username, all_preds, match_names):
wins = 0
for mn in match_names:
mp = [p for p in all_preds if p["match_name"]==mn and p.get("actual_score") is if not mp: continue
my = next((p for p in mp if p["player"]==username), None)
if not my: continue
my_d = abs(int(my.get("predicted_score") or 0) - int(my.get("actual_score") or 0))
min_d = min(abs(int(p.get("predicted_score") or 0) - int(p.get("actual_score") if my_d == min_d: wins += 1
return wins
not No
or 0))
def calc_rank(username, mn, all_preds):
mp = [p for p in all_preds if p["match_name"]==mn and p.get("actual_score") is not if not mp: return None
my = next((p for p in mp if p["player"]==username), None)
if not my: return None
None]
my_d = abs(int(my.get("predicted_score") or 0) - int(my.get("actual_score") or 0))
diffs = sorted([abs(int(p.get("predicted_score") or 0) - int(p.get("actual_score") return diffs.index(my_d) + 1 if my_d in diffs else 99
or 0))
...
preds = db().table("predictions").select("*").eq("match_name", match_sel).execute().data
if not preds: return
for p in preds:
...
if role == "admin":
pages += [" Enter Results"," BP Results"," Lock / Cancel"," King's Panel"]
return pages
# ══════════════════════════════════════════════════════════════════════════════
# LEADERBOARD
# ══════════════════════════════════════════════════════════════════════════════
...
return s
st.dataframe(df.style.apply(style_df, axis=None), use_container_width=True, hide_index=Tr
# ══════════════════════════════════════════════════════════════════════════════
# OVERALL STATS
# ══════════════════════════════════════════════════════════════════════════════
...
" Points Race", " Accuracy", " Podium Tracker", " Head to Head", " Full Ta
])
with tab1:
st.subheader(" cum_data = {}
for u in users:
Points Race — Match by Match")
un = u["username"]; team = u.get("team_name") or un
cum = 0; cum_data[team] = []
for mn in match_names:
mp = next((p for p in all_preds if p["player"]==un and p["match_name"]==mn),
if mp: cum += int(float(mp.get("points_awarded") or 0))
mb = next((b for b in all_bps if b["player"]==un and b["match_name"]==mn), No
if mb: cum += int(float(mb.get("points_awarded") or 0))
cum_data[team].append(cum)
st.line_chart(pd.DataFrame(cum_data, index=[f"M{match_map[mn]}" for mn in match_names
st.markdown("---")
st.caption(" Filter match range:")
total_m = len(match_names)
if total_m > 2:
c1,c2 = st.columns(2)
with c1: start_m = st.number_input("From Match #", min_value=1, max_value=total_m
with c2: end_m = st.number_input("To Match #", min_value=1, max_value=total_m
...
cum = 0; f_data[team] = []
for mn in f_names:
mp = next((p for p in all_preds if p["player"]==un and p["match_name"]==m
if mp: cum += int(float(mp.get("points_awarded") or 0))
mb = next((b for b in all_bps if b["player"]==un and b["match_name"]==mn)
if mb: cum += int(float(mb.get("points_awarded") or 0))
f_data[team].append(cum)
st.line_chart(pd.DataFrame(f_data, index=[f"M{match_map[mn]}" for mn in f_names])
not No
with tab2:
...
for u in users:
un = u["username"]; team = u.get("team_name") or un
up = [p for p in all_preds if p["player"]==un and p.get("actual_score") is sp_w = calc_sp_wins(un, all_preds, match_names)
played = len(up)
corr_w = sum(1 for p in up if caps(p.get("predicted_winner",""))==caps(p.get("ac
corr_wk = sum(1 for p in up if int(p.get("predicted_wickets") or -1)==int(p.get("
margin = sum(abs(int(p.get("predicted_score") or 0)-int(p.get("actual_score") or
exacts = sum(1 for p in up if int(p.get("predicted_score") or 0)==int(p.get("act
...
m_df = pd.DataFrame([{"Team":r["Team"],"Margin of Error":r["Margin of Error"]} st.bar_chart(m_df.set_index("Team"), use_container_width=True, height=300)
for r
with tab3:
...
"Missed":missed,"Attendance %":f"{round(attended/len(match_names)*100)}%" if
...
top_sec = sorted(podium_rows, key=lambda x: x[" cols = st.columns(3)
2nd"], reverse=True)[:3]
for i,(col,row) in enumerate(zip(cols, top_sec)):
with col:
st.markdown(f"""<div style='background:{"#FFD700" if i==0 else "#C0C0C0" if i
...
def h2h(u):
un = u["username"]
up = [p for p in all_preds if p["player"]==un and p.get("actual_score") is no
...
"Correct Winners": sum(1 for p in up if caps(p.get("predicted_winner","
"Margin of Error": sum(abs(int(p.get("predicted_score") or 0)-int(p.get
...
rows_h.append({"Stat":stat, p1n:f" {v1}" if w1 else str(v1), p2n:f" st.markdown(f"### {p1n} {p2n}")
...
for u in users:
un = u["username"]; team = u.get("team_name") or un
up = [p for p in all_preds if p["player"]==un and p.get("actual_score") is ubps = [b for b in all_bps if b["player"]==un]
full.append({
"Team":team,"Total":int(total_pts(un)),
"SP Pts":int(sp_pts(un)),"BP Pts":int(bp_pts(un)),"Streak Pts":int(streak_pts
"SP Wins":calc_sp_wins(un, all_preds, match_names),
"BP Correct":sum(1 for b in ubps if b.get("result")=="correct"),
"BP Wrong":sum(1 for b in ubps if b.get("result")=="wrong"),
"Exacts":exact_count(un),
"Correct Winners":sum(1 for p in up if caps(p.get("predicted_winner",""))==ca
"Margin of Error":sum(abs(int(p.get("predicted_score") or 0)-int(p.get("actua
"Attended":len(set(p["match_name"] for p in all_preds if p["player"]==un)),
"Missed":len(match_names)-len(set(p["match_name"] for p in all_preds if p["pl
" Streak":current_streak(un),
})
...
if streak > 1: st.success(f" Active streak: **{streak} wins in a row!** (+{streak_bonus
st.markdown("---")
if tot > 0:
st.subheader(" Points Breakdown")
st.bar_chart(pd.DataFrame({"Category":["SP","BP","Streak"],"Points":[s_pts,b_pts,st_p
st.markdown("---")
...
"Predicted":f"{p.get('predicted_score')} - {str(p.get('predicted_wickets',0)).zfi
"Actual":f"{p.get('actual_score')} - {str(p.get('actual_wickets',0)).zfill(2)} |
" ":" " if p.get("actual_score") and int(p.get("predicted_score") or 0)==int(p
...
"Result":" " if b.get("result")=="correct" else " " if b.get("result")=="wrong"
...
name,val = data[pos]
with cols[ci]:
st.markdown(f"""<div style='background:{colors[pos]};padding:{pads[pos]};border-r
...
"attended":len(set(p["match_name"] for p in all_preds if p["player"]==un)),
"corr_w":sum(1 for p in up if caps(p.get("predicted_winner",""))==caps(p.get("act
"corr_wk":sum(1 for p in up if int(p.get("predicted_wickets") or -1)==int(p.get("
...
render_podium(' "Checked Out"',top3("attended",rev=False),"Matches Attended")
...
mm = get_match_map()
match_sel = st.selectbox("Select Match", [f"#{mm.get(m['match_name'],'?')} — {m['match_na
match_name = match_sel.split(" — ",1)[1]
existing = db().table("pool_bps").select("*").eq("player", st.session_state.user["usernam
if existing:
b=existing[0]
icon=" " if b.get("result")=="correct" else " " if b.get("result")=="wrong" else "
st.warning(" Already submitted!")
st.info(f"{icon} **{b['prediction_text']}** | Pts: {int(float(b.get('points_awarded',
return
# Category tabs
...
if bp.get("note"): st.info(f" **Note:** {bp['note']}")
inputs = []
...
"points_awarded": 0, "submitted_at": datetime.now().strftime("%Y-%m-%d %H
}).execute()
...
ex2 = db().table("pool_bps").select("*").eq("player", st.session_state.user["user
...
match_sel = st.selectbox("Select Match", [f"#{mm.get(m['match_name'],'?')} — {m['match_na
match_name = match_sel.split(" — ",1)[1]
existing = db().table("predictions").select("*").eq("player", st.session_state.user["user
if existing:
p=existing[0]
st.warning(" Already submitted!")
st.info(f"**{p['predicted_score']} - {str(p.get('predicted_wickets',0)).zfill(2)} | {
return
c1,c2 = st.columns(2)
with c1:
...
st.title(" BP Results")
st.markdown("---")
pending = db().table("pool_bps").select("*").eq("status","pending").execute().data if not pending: st.info("No BPs waiting."); return
...
db().table("pool_bps").update({"result":"correct","points_awarded":3,"status"
st.rerun()
with c2:
if st.button(" Wrong (-1)", key=f"w_{b['id']}"):
db().table("pool_bps").update({"result":"wrong","points_awarded":-1,"status":
st.rerun()
if b.get("bp_type")=="custom":
with c3:
if st.button(" Dismiss (0)", key=f"d_{b['id']}"):
db().table("pool_bps").update({"result":"dismissed","points_awarded":0,"s
st.rerun()
st.markdown("---")
# ══════════════════════════════════════════════════════════════════════════════
# ENTER RESULTS
...
matches = get_matches()
mm = {m["match_name"]: i+1 for i, m in enumerate(matches)}
pending = [m for m in matches if m.get("sp_locked") and m.get("status") not in ["done","c
if not pending: st.info("No matches waiting for results."); return
sel = st.selectbox("Select Match", [f"#{mm[m['match_name']]} — {m['match_name']}" for m i
match_name = sel.split(" — ",1)[1]
actual_score = st.number_input("Actual Score (runs)", min_value=0, max_value=500, step=
...
mm = {m["match_name"]: i+1 for i, m in enumerate(matches)}
for m in matches:
with st.expander(f"Match #{mm[m['match_name']]} — {m['match_name']} | {m.get('status'
c1,c2 = st.columns(2)
with c1:
if m.get("bp_locked"):
st.success(f" BP locked by **{get_team(m.get('bp_locked_by',''))}** at
if st.button(" Unlock BP", key=f"ubp_{m['id']}"):
db().table("matches").update({"bp_locked":False,"bp_locked_by":None,"
st.rerun()
else:
if st.button(" Lock BP", key=f"lbp_{m['id']}"):
db().table("matches").update({"bp_locked":True,"bp_locked_by":user["u
st.rerun()
with c2:
if m.get("sp_locked"):
st.success(f" SP locked by **{get_team(m.get('sp_locked_by',''))}** at
if st.button(" Unlock SP", key=f"usp_{m['id']}"):
db().table("matches").update({"sp_locked":False,"sp_locked_by":None,"
st.rerun()
else:
SP"],
if st.button(" Lock SP", key=f"lsp_{m['id']}"):
db().table("matches").update({"sp_locked":True,"sp_locked_by":user["u
st.rerun()
if m.get("status") != "cancelled":
st.markdown("** Cancel due to rain:**")
cancel_type = st.selectbox("What to cancel?",
["Select...","Cancel BP only","Cancel SP only","Cancel both BP and key=f"csel_{m['id']}")
if cancel_type != "Select...":
if st.button(f" Confirm — {cancel_type}", key=f"cancel_{m['id']}"):
if "BP" in cancel_type:
db().table("pool_bps").update({"points_awarded":0,"status":"cance
if "SP" in cancel_type:
db().table("predictions").update({"points_awarded":0,"status":"ca
if cancel_type == "Cancel both BP and SP":
db().table("matches").update({"status":"cancelled"}).eq("id",m["i
...
m = matches[idx]
st.markdown(f"### Match #{mm[m['match_name']]} — {m['match_name']} | {m.get('match_dat
c1,c2,c3 = st.columns(3)
...
st.success(f"**Result:** {m.get('actual_winner')} won | {m.get('actual_score')} - {st
st.markdown("---")
st.subheader(" Bold Predictions")
bps = db().table("pool_bps").select("*").eq("match_name",m["match_name"]).execute().data
if bps:
st.dataframe(pd.DataFrame([{
...
st.markdown("---")
st.subheader(" Score Predictions")
preds = db().table("predictions").select("*").eq("match_name",m["match_name"]).execute().
if preds:
...
"Predicted":f"{p.get('predicted_score')} - {str(p.get('predicted_wickets',0)).zfi
"Actual":f"{m.get('actual_score')} - {str(m.get('actual_wickets',0)).zfill(2)} |
" ":" " if m.get("actual_score") and int(p.get("predicted_score") or 0)==m.get
...
st.markdown("**Points:** Orange Cap=20 | Purple Cap=20 | Emerging=15 | Top4 team=6 (+4 if
oc=st.text_input(" Orange Cap"); pc=st.text_input(" Purple Cap"); em=st.text_input("
t1=st.text_input("1st"); t2=st.text_input("2nd"); t3=st.text_input("3rd"); t4=st.text_inp
if st.button(" Submit", use_container_width=True):
...
st.write(f"**#{mm[m['match_name']]}** **{m['match_name']}** | BP:{bp} SP:{sp}
with tab2:
...
st.write(f"{ROLE_LABELS.get(u['role'],'?')} **{u.get('team_name') or u['display_n
with tab3:
oc=st.text_input(" Orange Cap"); pc=st.text_input(" Purple Cap"); em=st.text_inpu
t1=st.text_input("1st"); t2=st.text_input("2nd"); t3=st.text_input("3rd"); t4=st.text
if st.button("Award Season Points"):
actuals={"oc":caps(oc),"pc":caps(pc),"em":caps(em),"t1":caps(t1),"t2":caps(t2),"t
...
pt4=[sp.get("top1","").upper(),sp.get("top2","").upper(),sp.get("top3","").up
for j,tn in enumerate(pt4):
if tn in at4:
pts+=6
if tn==at4[j]: pts+=4
db().table("season_predictions").update({"points_awarded":pts}).eq("id",sp["i
st.success(" Done!")
# ══════════════════════════════════════════════════════════════════════════════
# MAIN
# ══════════════════════════════════════════════════════════════════════════════
...
st.session_state.user={"username":"guest","display_name":"Guest","role":"gues
st.session_state.page=" Leaderboard"
st.rerun()
return
user=st.session_state.user
...
elif page==" King's Panel": page_admin()
