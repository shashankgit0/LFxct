...
“shank”:  {“name”: “Shank Tacticos”,           “players”: [“Hardik Pandya”,“Noor Ahmad”,“Tilak Varma”,“Priyansh Arya”,“Varun Chakaravarthy”,“Dhruv Jurel”,“Pat Cummins”,“Marcus Stoinis”,“Anukul Roy”,“Nitish Rana”,“Vaibhav Arora”,“Matheesha Pathirana”]},
...
disp = bp[“template”].replace(”{name}”,”******”)
if st.button(disp, key=f”bp*{bp[‘key’]}”, use_container_width=True):
...
st.markdown(f”#### Selected: *{tmpl.replace(’{name}’,’*****_’)}*”)
...
1. Select all text on the page **(Ctrl+A / Cmd+A)** and copy it **(Ctrl+C / Cmd+C)**
1. Paste it below and hit **Parse & Update**
   “””)
